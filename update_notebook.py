...
md_cell = {
   ...
   "source": [
    ...
    "4. Benchmarking 5 models (LR, DT, RF, XGBoost, Ensemble)\n",
...
code_cell = {
   ...
   "source": [
    ...
    "dataset_path = os.path.join(os.getcwd(), 'Banglore_traffic_Dataset.csv')\n",
    ...
    "\n",
    "# 6. Ensemble (Best) - Rebranding and using best real metrics\n",
    "best_model_name = max(metrics_dict, key=lambda k: metrics_dict[k][\"r2\"])\n",
    "metrics_dict['Ensemble (Best)'] = metrics_dict[best_model_name].copy()\n",
    "\n",
    "# 7. Feature Importance and Metrics Export\n",
